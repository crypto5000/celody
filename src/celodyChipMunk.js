...
/* "chipmunk" module requires 1 instrument (primary-secondary pair) only - no multiple instruments
*  randomly changes tempo/pitch to higher pitch and faster tempo
...
var celodyLoopTimer;
function playChipMunkStream(celody,loopCount) {                                                     
    celody.countIndex = 0;
    celody.countMax = 0;
    ...
    while (celody.countIndex < celody.countMax) {      
        ...
        // adjust the new soundrate for the chipmunk effect
    ...
    if (celody.streamInfo[0].stop) {
        ...
        playChipMunkStream(celody,loopCount);
    } else {                                  
        celodyLoopTimer = setTimeout(function(){ playChipMunkStream(celody,loopCount); }, (celody.timePerLoop * 1000) - (performance.now() - celody.masterStart));                                       
    }
