...
/* "slowdeep" module requires 1 instrument (primary-secondary pair) only - no multiple instruments
*  randomly changes tempo/pitch to lower pitch and slower tempo
...
var celodyLoopTimer;
function playSlowDeepStream(celody,loopCount) {                                                     
    celody.countIndex = 0;
    celody.countMax = 0;
    ...
    while (celody.countIndex < celody.countMax) {      
        ...
        // adjust the new soundrate for the slowdeep effect
    ...
    if (celody.streamInfo[0].stop) {
        ...
        playSlowDeepStream(celody,loopCount);
    } else {                                  
        celodyLoopTimer = setTimeout(function(){ playSlowDeepStream(celody,loopCount); }, (celody.timePerLoop * 1000) - (performance.now() - celody.masterStart));                                       
    }
